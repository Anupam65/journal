        ...
        <header className="header">
          <nav className="nav-container">
            ...
            <div className="nav-links">
              ...
              <a href="#" className="nav-link">Submit Paper</a>
            ...
            <div className="review-grid">
              ...
              <div className="review-card">
                <div className="review-header">
                  <img src="https://placehold.co/48x48/667eea/ffffff?text=JP" alt="Reviewer's avatar" className="reviewer-avatar" />
              ...
              <div className="review-card">
                <div className="review-header">
                  <img src="https://placehold.co/48x48/667eea/ffffff?text=RS" alt="Reviewer's avatar" className="reviewer-avatar" />
                  <div className="reviewer-info">
